...
export default function App() {
  ...
  return <div className={`appShell ${collapsed ? 'collapsed ' : ''}${mobile ? 'menuOpen' : ''}`}>
    <aside className="sidebar">
      <button className="mobileMenuClose" onClick={() => setMobile(false)} aria-label="Fechar filtros">×</button>
    ...
    <main className="content">
      <div className="mobileTop"><button onClick={() => setMobile(true)}>Filtros ☰</button></div>
