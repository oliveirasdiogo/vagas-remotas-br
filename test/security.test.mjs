...
test('aceita a descrição pública completa da Remotar dentro do limite seguro', () => assert.equal(normalizeJob({ ...valid, description:'A'.repeat(20_000) }).description.length, 20_000))
